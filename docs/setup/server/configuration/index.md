...
| [general_volatileMode](../features/volatile-mode.md) | false                                                              | boolean                                  | Enable volatile mode (in-memory database, data lost on restart)       |

## Anticensor-Specific Features

Anticensor extends Spacebar with additional features and configuration options. For detailed information about these features, see the following documentation:

- [User Consent Management](../features/consents.md) - GDPR-compliant consent tracking system
- [Lobby System](../features/lobbies.md) - Ephemeral matchmaking and coordination lobbies
- [Thread Promotion](../features/thread-promotion.md) - Convert threads to top-level channels
- [Volatile Mode](../features/volatile-mode.md) - In-memory database for testing and development
- [Configurable Limits](../features/configurable-limits.md) - Comprehensive limit configuration system
- [Anticensor Enhancements](../features/anticensor-enhancements.md) - Additional feature enhancements including:
    - Slowmode with arbitrary seconds support
    - PIN_MESSAGES permission split from MANAGE_MESSAGES
    - Doubly-linked replies for conversation threading
    - Guild template support (including Discord.com templates)
